...
SOURCES = \
	__init__.py \
	geo_buffers.py geo_buffers_dialog.py

PLUGINNAME = geo_buffers

PY_FILES = \
	__init__.py \
	geo_buffers.py geo_buffers_dialog.py

UI_FILES = geo_buffers_dialog_base.ui
...
QGISDIR=C:\Users\Phill Mojoo\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
